...
def main():
    ...
    try:
        log_parser_module = LogParser(
            gui_module, api_client_module, sound_module, cm_module, kt.local_version, kt.monitoring, kt.discord_id, kt.rsi_handle, kt.player_geid, kt.active_ship, kt.anonymize_state
        )
    except Exception as e:
